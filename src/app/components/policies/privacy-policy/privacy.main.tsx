...
const Privacy: React.FC = () => {
    ...
    return (
        <main className={classes.content}>
            ...
            <Typography variant='h4' component='h4' gutterBottom id='what-information-we-collect'>
            ...
            <Typography variant='h4' component='h4' gutterBottom id='how-we-use-your-information'>
