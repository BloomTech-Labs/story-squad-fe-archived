...
const TosMain: React.FC = () => {
    ...
    return (
        <main className={classes.content}>
            ...
            <Typography variant='h4' component='h4' gutterBottom id='account-access-and-security'>
                {tosMappedContent[9]}
            </Typography>
            ...
            <Typography variant='h4' component='h4' gutterBottom id='your-intellectual-property'>
                {tosMappedContent[23]}
            </Typography>
